...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/10/30 16:02:36 by dansimoe          #+#    #+#             */
...
int	main()
{
	...
	header = lstnew(sub2[1]);
	second = lstnew(sub2[2]);
	third = lstnew(sub2[3]);
	header->next = second;
	second->next = third;
	if (sigsetjmp(jump_buffer, 1) == 0)
	...
	header = lstnew(sub3[1]);
	second = lstnew(sub3[2]);
	third = lstnew(sub3[3]);
	header->next = second;
	second->next = third;
	if (sigsetjmp(jump_buffer, 1) == 0)
	...
	header = lstnew(&sub4[1]);
	second = lstnew(&sub4[2]);
	third = lstnew(&sub4[3]);
	header->next = second;
	second->next = third;
	if (sigsetjmp(jump_buffer, 1) == 0)
	...
	header = lstnew(&sub5[1]);
	second = lstnew(&sub5[2]);
	third = lstnew(&sub5[3]);
	header->next = second;
	second->next = third;
	if (sigsetjmp(jump_buffer, 1) == 0)
	...
	///////////Test 1///////////
	char	exp6[4][1024] = {"NULL", "00", "42", "1024"};
	char	sub6[4][1024] = {"NULL", "00", "42", "1024"};
	header = lstnew(sub6[1]);
	second = lstnew(sub6[2]);
	third = lstnew(sub6[3]);
	header->next = second;
	second->next = third;
	if (sigsetjmp(jump_buffer, 1) == 0)
